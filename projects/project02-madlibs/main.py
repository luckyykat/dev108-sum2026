...
if play_again == "y":
    ...
    while play_again == "y":
        ...
        while story_choice != "a" and story_choice != "b":
            print("That challenge is not available. Please enter a or b.")
            story_choice = input("Which challenge would you like? (a/b): ").lower()
